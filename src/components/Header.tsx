    ...
    <header className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 sm:py-6 shadow-lg print:hidden relative">
      <div className="container mx-auto px-4">
        ...
        <p className="text-blue-100 text-xs sm:text-sm">
          Fitness Architect - 根据你的目标和条件，生成量身定制的智能训练计划
        </p>
      </div>
      ...
      {/* ✅ 键盘快捷键提示 */}
      <div className="absolute bottom-2 left-4 text-xs text-blue-200 opacity-75 hidden sm:block">
        <span className="mr-3">快捷键：ESC 关闭弹窗</span>
        <span>⌘K 清空表单</span>
      </div>
    </header>
  );
