 ...
 * 根据是否有计划，动态调整引导步骤
 */
export default function Tutorial({ run, onTourComplete, hasPlan }: TutorialProps) {
  // ✅ 根据当前状态动态生成步骤
  const getSteps = (): Step[] => {
    // 阶段1：初始页面（未生成计划）
    if (!hasPlan) {
